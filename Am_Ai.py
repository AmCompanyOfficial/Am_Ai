...
class Emotion:
    def __init__(self):
        ...
        self.power = 100  # قدرت اختیار ربات به میزان 100
        self.actions = []  # برای ذخیره کارهایی که ربات می‌خواهد انجام دهد
...
# ========================
# سیستم تصمیم‌گیری با اراده و اختیار
# ========================
...
def main():
    ...
    # اجرای وظایف خودمختار در یک رشته جداگانه
